terraform {
  ...
  # Uncomment and configure after creating the S3 bucket and DynamoDB table manually:
  # backend "s3" {
  #   bucket         = "truck-shipping-terraform-state"
  #   key            = "prod/terraform.tfstate"
  #   region         = "us-east-1"
  #   encrypt        = true
  #   dynamodb_table = "truck-shipping-terraform-locks"
  # }
}
